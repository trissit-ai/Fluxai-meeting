import { LocalParticipant, Room, RoomEvent, type Participant, type TrackPublication, type RoomEventCallbacks } from 'livekit-client';
...
export declare function createDataObserver(room: Room): Observable<[payload: Uint8Array<ArrayBuffer>, participant?: import("livekit-client").RemoteParticipant | undefined, kind?: import("livekit-client").DataPacket_Kind | undefined, topic?: string | undefined, encryptionType?: import("livekit-client").Encryption_Type | undefined]>;
